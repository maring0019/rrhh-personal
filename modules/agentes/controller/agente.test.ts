...
describe('Controles sobre atributos requeridos de un Agente ', () => {
    it('Si el agente no tiene todos los atributos requeridos, retornar un array con los atributos faltantes',
        async () => {
            const agente = {
                nombre: 'Marcos',
                apellido: 'Cisterna',
    ...
    it('Si el agente tiene todos los atributos pero algun/os atributo/s es nulo, retornar un array con el atributo faltante',
        async () => {
            const agente = {
                documento: '28588178',
                nombre: '',
    ...
    it('Si el agente tiene todos los atributos y valores requeridos, retornar un array vacio',
        async () => {
    ...
    it('Si el agente no tiene los atributos requeridos no se puede determinar la existencia del agente,' + 
        'por lo tanto retornar error indicando esta situacion', async () => {
        const agente = {
            nombre: 'Marcos',
            apellido: 'Cisterna',
            sexo:'',
